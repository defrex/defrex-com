...
// Colors using Tailwind's zinc and sky color palette
const fgMainColor = '#a1a1aa' // zinc-400
const grey = '#52525b' // zinc-600
const colorScale = [
  '#fafafa', // zinc-50
  '#f4f4f5', // zinc-100
  '#e4e4e7', // zinc-200
...
// * Typography
// *
const sansSerif = "'Open Sans', -apple-system, BlinkMacSystemFont, 'Helvetica Neue', sans-serif"
  ...
  area: assign(
    {
      style: {
        data: {
          fill: '#0ea5e930', // sky-500 30% opacity
        },
